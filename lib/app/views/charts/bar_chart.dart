...
class BarChartViewState extends State<BarChartView> {
              ...
              children: <Widget>[
                Row(
                  ...
                  children: <Widget>[
                    ...
                    SPACER,
                    Text('Transactions State', style: h4_light(context)),
                    SPACER,
                  ],
                ),
                const SizedBox(
  ...
  Widget makeTransactionsIcon() {
    ...
    return Row(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CROSS_AXIS_END,
      children: <Widget>[
        Container(width: width, height: 10, color: APP_LIGHT_GREY),
        const SizedBox(
          width: space,
        ),
        Container(width: width, height: 18, color: APP_LIGHT_GREY),
        const SizedBox(
          width: space,
        ),
        Container(width: width, height: 22, color: APP_LIGHT_GREY),
        const SizedBox(
          width: space,
        ),
        Container(width: width, height: 14, color: APP_LIGHT_GREY),
      ],
    );
  }
}
